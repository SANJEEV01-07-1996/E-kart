...
define('DOMAIN_URL','https://apppanel.in/'); /* https://appadmin.in/ change to your domain URL of your admin panel. Don't forget to add forward slash at the end "/" */
define('JWT_SECRET_KEY','replace_with_your_strong_jwt_secret_key'); /* change to your secret key here replace_with_your_strong_jwt_secret_key */
